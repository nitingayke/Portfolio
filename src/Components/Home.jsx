    ...
    return (
        ...
        <section id="home" className="md:h-screen flex flex-wrap items-center justify-evenly pt-10 md:pt-0">
            ...
            <div className='w-full md:w-2/5 px-5 md:pb-20 md:p-12 md:mt-10 lg:p-10'>
                <div className='p-1'>
                    <div className='home-user-image w-fit mx-auto w-auto md:w-full'>
                        <img src="public/assets/userimage.png" alt="" className='rounded-full md:w-full md:h-auto mx-auto bg-[#161b1e] p-5 ' />
                    </div>
                </div>
            </div>
        </section>
